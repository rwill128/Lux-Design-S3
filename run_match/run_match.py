...
if __name__ == "__main__":
    ...
    evaluate_agents(BestAgentBetterShooter, BestAgentAttackerNoNebulaDifferentExploreNoAttack, games_to_play=20, seed=2,
                    replay_save_dir="replays/" + BestAgentBetterShooter.__name__ + "_" + BestAgentAttackerNoNebulaDifferentExploreNoAttack.__name__)
